...
module "smrtlink_configs" {
  source                  = "git::https://github.com/Ferlab-Ste-Justine/terraform-cloudinit-templates.git//smrtlink?ref=v0.50.3"
...
module "s3_mounts" {
  source               = "git::https://github.com/Ferlab-Ste-Justine/terraform-cloudinit-templates.git//s3-mounts?ref=v0.50.3"
  mounts               = var.s3_mounts
  install_dependencies = var.install_dependencies
}

module "s3_backups" {
  source       = "git::https://github.com/Ferlab-Ste-Justine/terraform-cloudinit-templates.git//s3-syncs?ref=v0.50.3"
  object_store = {
